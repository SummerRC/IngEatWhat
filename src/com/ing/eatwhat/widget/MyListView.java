/*
 * 用的文件：CustomListView.java   head.xml		arrow.png   progress_bg.xml		colors.xml  strings.xml
 *			listfooter_more.xml
 */


package com.ing.eatwhat.widget;
...
public class MyListView extends ListView implements OnScrollListener {
	...
	public MyListView(Context pContext, AttributeSet pAttrs) {
	...
	public MyListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
	...
	private void addHeadView() {
		mHeadView = (LinearLayout) mInflater.inflate(R.layout.fragment_forum_head, null);
	...
	private void addFooterView() {
		mEndRootView = mInflater.inflate(R.layout.fragment_forum_footer, null);
...
//				}
	...
	private void changeHeaderViewByState() {
		...
		case REFRESHING:
			...
			// 华生的建议： 实际上这个的setPadding可以用动画来代替。其实有的人也用Scroller可以实现这个效果，
